...
public class MapNav : MonoBehaviour
{
    ...
    IEnumerator MapPosition()
    {
        ...
        url = "https://open.mapquestapi.com/staticmap/v5/map?key=" + key + "&size=" + mapSize[indexSize].ToString() + "," + mapSize[indexSize].ToString() + "@2x&zoom=" + zoom + "&format=" + mapFormat[indexFormat] + "&type=" + maptype[indexType] + "&center=" + fixLat + "," + fixLon;
    ...
    Vector3 WGS84toWebMercator(float _lon, float _lat, float elevation)
    {
